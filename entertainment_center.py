...
# Movie Instances:
end_of_the_tour = media.Movie("The End of the Tour", 
	("In 1996, immediately"\
	"after the publication of one his best known and hugely successful novels,"\
	" Infinite Jest, David Foster Wallace goes ona five day touring interview"\
	" with Rolling Stone reporter and writer David Lipsky"),
...
love_and_mercy =  media.Movie("Love & Mercy", 
...
steve_jobs = media.Movie("Steve Jobs", 
	...
	" launches and ending in 1998 with the unveiling of the iMac, Steve Jobs"\
	" takes us behind the scenes of the digital revolution to paint an intimate"\
	" portrait of the brilliant man at its epicenter."), 
